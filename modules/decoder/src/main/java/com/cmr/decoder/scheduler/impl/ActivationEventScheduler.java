...
import com.cmr.decoder.service.impl.ActivationUploadService;
 ...
 * @author rajith
 */
public class ActivationEventScheduler implements JobScheduler {

    private final static Logger logger = LoggerFactory.getLogger(ActivationEventScheduler.class);
    @Autowired
    ...
    @Override
    public void execute() {
        logger.info("Activation event scheduler starting to execute");
        uploadServiceStrategy.startUpload(new ActivationUploadService(poolSize, getFiles(),
