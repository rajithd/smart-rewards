...
import com.cmr.decoder.service.impl.thread.RegistrationProcessorThread;
 ...
 * @author rajith
 */
public class RegistrationUploadService implements UploadService {

    private static final Logger logger = LoggerFactory.getLogger(RegistrationUploadService.class);
    ...
    public RegistrationUploadService(int poolSize, String[] files, String sourceDirectoryPath, String archiveDirectoryPath,
        ...
        try {
            ...
            while (charBuffer.hasRemaining()) {
                ...
                if (character == rawBreaker.charAt(0)) {
                    pool.execute(new RegistrationProcessorThread(builder.toString(),
