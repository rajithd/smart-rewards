...
import com.cmr.decoder.service.impl.SMSUploadService;
 ...
 * @author rajith
 */
public class SMSEventScheduler implements JobScheduler {

    private final static Logger logger = LoggerFactory.getLogger(SMSEventScheduler.class);
    ...
    @Override
    public void execute() {
        logger.info("SMS event scheduler starting to execute");
        uploadServiceStrategy.startUpload(new SMSUploadService(poolSize, getFiles(),
